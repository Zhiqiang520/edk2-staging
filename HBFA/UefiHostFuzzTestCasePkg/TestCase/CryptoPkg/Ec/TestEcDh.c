        ...
        UINTN PeerKeySize)
{
  ...
  EcComputeKey(Ec, PeeyKey, PeerKeySize, NULL, &KeyLength);
  EcComputeKey(Ec, PeeyKey, PeerKeySize, Key, &KeyLength);
  EcComputeKey(Ec, PeeyKey, PeerKeySize / 2, Key, &KeyLength);
